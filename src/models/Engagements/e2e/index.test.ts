...
let emailsSent:any[] = []
function email() {
  this.add('role:sendgrid,cmd:sendTemplate', async function(msg) {
...
test('create', async function(t) {
  ...
  t.equal(email.subject, 'Sit Tight! Test Fest has your application.')
})
